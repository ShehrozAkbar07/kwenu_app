...
class OfferLoan extends StatefulWidget {
  const OfferLoan({super.key});

  @override
  State<OfferLoan> createState() => _OfferLoanState();
}

class _OfferLoanState extends State<OfferLoan> {
