          ...
          body: Column(
            children: [
              CustomAppBarMarketPlace(
                  text: 'Clothing', hint_text: 'Search Clothing'),
              Flexible(
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: AssetImage(
                                          'assets/images/adidas_image.png'),
                                      fit: BoxFit.cover),
                                ),
                              ),
                              SizedBox(width: 10.w),
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: const DecorationImage(
                                      image: AssetImage(
                                          'assets/images/maroon_shirt.png'),
                                      fit: BoxFit.cover),
                                ),
                              ),
                            ],
...
class reusablerow extends StatelessWidget {
  ...
  const reusablerow({Key? key, required this.reusablerow_text})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        InkWell(
          onTap: () {
            Get.toNamed(AppRoutes.market_place_sub_category);
          },
          child: Text(
            'View All',
            style: TextStyle(
